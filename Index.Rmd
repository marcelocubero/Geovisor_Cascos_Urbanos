...
cuadrantes <-
  st_read(
    "/vsicurl/https://marcelocubero.github.io/capas_visor/cuadrantes.geojson",
    quiet = TRUE
  )

mep <-
  st_read("/vsicurl/https://marcelocubero.github.io/capas_visor/mep.geojson",
          quiet = TRUE)

localidades <-
  st_read(
    "/vsicurl/https://marcelocubero.github.io/capas_visor/localidades.geojson",
    quiet = TRUE
  )
...
# Transparencia de la capa Cuadrantes
...
renderLeaflet({
  registros <-
   ...
   mep_c <- mep [registros, , op = st_intersects]
   localidades_c <- localidades [registros, , op = st_intersects]
